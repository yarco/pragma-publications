...
// SPARQL is DBLP's daily-synced RDF API, hosted apart from the HTML/XML
// frontend. The XML person feeds (`/pid/{pid}.xml`) and their mirrors share
// one web backend and have returned HTTP 503 for hours at a time; SPARQL
// served the same 69 records while that backend was down. Daily sync is
// enough: this pipeline publishes a static snapshot, not live search.
